...
#     # 2. SSH 구조일 경우
#     if cfg.get('SSH', False):
#         print(">> [create_backbone] Using SSH structure")
...
#             ]
#         else:
#             raise ValueError("Unsupported return_layers config")
...
#     # 3. FPN 구조일 경우
#     print(">> [create_backbone] Using FPN structure")
#     if len(cfg['return_layers']) == 3:
#         in_channels_list = [
#             in_channels * 2,
#             in_channels * 4,
...
#     out_channels = cfg['out_channel']
#     return BackBoneWithFPN(feat_ext, cfg['return_layers'],
#                            in_channels_list,
#                            out_channels,
#                            context_module=context,
#                            use_deform=use_deform,
