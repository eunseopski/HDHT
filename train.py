...
def train():
    ...
    optimizer = torch.optim.SGD(params, lr=HYP_CFG['learning_rate'], # SCUT-Head, Crowdhuman 학습할 때
                                momentum=HYP_CFG['learning_rate'],
                                weight_decay=HYP_CFG['weight_decay'])
    # optimizer = torch.optim.Adam(params, lr=HYP_CFG['learning_rate'], # CroHD 학습할 때
    #                              weight_decay=HYP_CFG['weight_decay'])
